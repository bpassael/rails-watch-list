...
top_movies.each do |movie|
  response = URI.open("https://www.omdbapi.com/?t=#{movie}&apikey=#{key}").read
  movie = JSON.parse(response)
  if movie['Title']
    Movie.create(title: movie['Title'], overview: movie['Plot'], poster_url: movie["Poster"], rating: movie["imdbRating"].to_f )
  end
end
